    ...
    <div class="container-fluid pt-2 pb-2" style="background-color: #f8f9fa;">
        <div class="container-fluid">
            ...
            <div class="grid-item image-content">
                    <img src="img/tech1.jpg" class="responsive-image" alt="Technology Consulting Image" />
                </div>
                <div class="grid-item text-content">
                    <h4 class="mt-4" style="animation: fadeInLeft 0.6s ease forwards;">Technology Consulting</h4>
                    <p style="color: black; margin-bottom: 15px; animation: fadeInLeft 0.6s ease forwards;">
                        Align Your Goals with the Right Technology and Expertise
                    </p>
                    <p style="color: black; animation: fadeInLeft 0.6s ease forwards;">
                        In today’s fast-evolving digital landscape, having a trusted technology advisor is essential.
                        Mastering emerging technologies and seamlessly integrating them into your business
                        operations is key to long-term success. With the right technological resources aligned to
                        your objectives, your business can unlock new growth opportunities.
                    </p>
                </div>
        ...
        <!-- <div class="container-fluid">
            <div class="grid-container">
                <div class="grid-item image-content">
                    <img src="img/tech2.jpg" class="responsive-image" alt="Technology Image" />
                </div>
                <div class="grid-item text-content">
                    <h4 class="mt-4" style="text-align: right; animation: fadeInRight 0.6s ease forwards;">Why is Technology Consulting Important?</h4>
                    <p style="text-align: right; color: black; animation: fadeInRight 0.6s ease forwards;">
                        Technology consulting is essential as it helps businesses leverage the right technology to improve efficiency, reduce costs,
                        and stay competitive. Consultants provide expert guidance on digital transformation, cybersecurity, cloud solutions, and software
                        development, ensuring innovative and scalable solutions.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="grid-container">
                <div class="grid-item text-content">
                    <h4 class="mt-4">Our key technology consulting elements:</h4>
                    <ul class="list-unstyled" style="color:black">
                        <li>1. IT strategy development</li>
                        <li>2. Account management</li>
                        <li>3. Helping you manage risk and transform business performance</li>
                    </ul>
                </div>
                <div class="grid-item image-content">
                    <img src="img/tech3.jpg" class="responsive-image" alt="Technology Elements" />
                </div>
            </div>
        </div> -->
    </div>
            ...
            <div class="container fade-in-right" style="position: relative; z-index: 2;">
                ...
                ">
                    ...
                    ">
                        ...
                        ">
                                    <p style="margin: 0;">1. IT strategy development</p>
                                </div>
                                <div class="benefit-item" style="
                            padding: 15px;
                        ...
                        ">
                                    <p style="margin: 0;">3. Help you manage your risk and transform business performance</p>
                                </div>
                                <!-- <div class="benefit-item" style="
                            padding: 15px;
