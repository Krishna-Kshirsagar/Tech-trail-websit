...
<body>
    ...
    <!-- Service End -->
    <!-- <div class="container-fluid pt-2 pb-2" style="background-color: #f8f9fa; display: grid; gap: 20px;">
        <div class="container-fluid" style="padding-left: 120px; display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); align-items: center; gap: 20px;">
            <div>
                <h4 style="animation: fadeInLeft 0.6s ease forwards; animation-delay: 0.6s;">Mobile Application Development</h4>
                <p style="color: black; margin-bottom: 15px; animation: fadeInLeft 0.6s ease forwards; animation-delay: 0.6s; opacity: 0;">
                    Discover the solutions With our smart mobile developers
                </p>
                <p style="color: black; animation: fadeInLeft 0.6s ease forwards; animation-delay: 0.9s; opacity: 0;">
                    Everyone is living in their smartphone these days. So it's only obvious to reach out to the world through its entrance. We at 'Techtrail', as a mobile application development company, provide you with a user-friendly, fast, and smart mobile application for your business.
                </p>
            </div>
            <img src="img/mob1.jpg" style="animation: fadeInRight 0.6s ease forwards; animation-delay: 0.6s; max-height: 250px; width: 100%; object-fit: cover;" alt="Mobile App Development Image" />
        </div>

        <div class="container-fluid pt-2 pb-2" style="padding-right: 120px; display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); align-items: center; gap: 20px;">
            <img src="img/mob2.jpg" style="animation: fadeInLeft 0.6s ease forwards; animation-delay: 0.6s; max-height: 250px; width: 100%; object-fit: cover;">
            <div>
                <h4 style="text-align: right; animation: fadeInRight 0.6s ease forwards; animation-delay: 0.9s;">Why is Mobile Application Development important?</h4>
                <p style="text-align: right; color: black; animation: fadeInRight 0.6s ease forwards; animation-delay: 0.9s;">
                    Mobile application development is important because it enables businesses to reach a wider audience, enhance customer engagement, and improve accessibility.
                </p>
            </div>
        </div>

        <div class="container-fluid pt-2 pb-2" style="padding-left: 120px; display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); align-items: center; gap: 20px;">
            <div>
                <h4>Our services include:</h4>
                <ul style="color:black">
                    <li>1. iOS App Development</li>
                    <li>2. Windows Mobile App Development</li>
                    <li>3. Mobile Apps Integration</li>
                    <li>4. Native Mobile App Testing, Support & Maintenance</li>
                    <li>5. Android Mobile App Development</li>
                </ul>
            </div>
            <img src="img/mob3.jpg" style="animation: fadeInRight 0.6s ease forwards; animation-delay: 0.6s; max-height: 250px; width: 100%; object-fit: cover;">
        </div>
    </div> -->
    <!-- Testimonial Start -->
        ...
        <div class="container-fluid">
            <div class="grid-container">
                <div class="grid-item text-content">
                    <h4 class="mt-4" style="animation: fadeInLeft 0.6s ease forwards;">Mobile Application Development</h4>
                    <p style="color: black; margin-bottom: 15px; animation: fadeInLeft 0.6s ease forwards;">
                        Unlock Powerful Solutions with Our Expert Mobile Developers
                    </p>
                    <p style="color: black; animation: fadeInLeft 0.6s ease forwards;">
                        In today’s mobile-first world, smartphones are the gateway to global connectivity. At
                        TechTrail, we specialize in crafting intuitive, high-performance mobile applications that
                        enhance user engagement and expand your business reach. Our expert mobile app
                        developers ensure your application is fast, user-friendly, and scalable, making it an
                        essential tool in your customers&#39; pockets.
                    </p>
                </div>
                <div class="grid-item image-content">
                    <img src="img/mob1.jpg" class="responsive-image" alt="Technology Consulting Image" />
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="container fade-in-right" style="position: relative; z-index: 2;">
                ...
                ">
                    ...
                    ">
                        ...
                        ">
                                    <p style="margin: 0;">1. iOS App Development</p>
                                </div>
                                <div class="benefit-item" style="
                            padding: 15px;
                        ...
                        ">
                                    <p style="margin: 0;">2. Android Mobile App Development</p>
                                </div> -->
                                <div class="benefit-item" style="
                            padding: 15px;
                        ...
                        ">
                                    <p >In one of our projects, we assisted the client in developing an application focused on
publishing medical articles. The platform was designed to prioritize providing detailed
information on a wide range of medical conditions, ensuring users had easy access to
valuable insights and resources.</p>

<p>In one of our medical applications, we developed the ActiveControl platform, designed for
RPM personnel and users to monitor the usage of inhalation devices. A web portal and
mobile app were created to seamlessly track device usage, provide data analysis, and offer
insightful visualizations.</p>

<p>Indrayani Education aimed to offer a comprehensive platform for civil service aspirants,
allowing users to purchase and participate in various exams multiple times. We created an
application which would focuses on designing and creating a user-friendly mobile app for
candidates, along with enhancements to the admin panel for effective management of
services, question banks, and payment transactions.</p>
                                </div>
                                <!-- <div class="benefit-item" style="
                            padding: 15px;
                        ...
                        ">
                                    <p style="margin: 0;">4. Mobile Apps Integration</p>
                                </div>
                                <div class="benefit-item" style="
                            padding: 15px;
                        ...
                        ">
                                    <p style="margin: 0;">5. Native Mobile App Testing, Support &amp; Maintenance</p>
                                </div> -->
                            </div>
                        </div>
                    </div>
            ...
            <div class="particles-container">
                ...
                ">
                    ...
                    ">
                            ...
                            animation: fadeInLeft 0.5s ease forwards;
                        ">
                                        <p style="margin: 0;">✅ Enterprise mobile architecture</p>
                                    </div>
                                    <div class="benefit-item" style="
                            padding: 15px;
                            ...
                            animation-delay: 0.1s;
                        ">
                                        <p style="margin: 0;">✅ Application UI/UX architecture development</p>
                                    </div>
                                    <div class="benefit-item" style="
                            padding: 15px;
                            background: rgba(155, 89, 182, 0.1);
                            ...
                            animation-delay: 0.2s;
                        ">
                                        <p style="margin: 0;">✅ Integration of existing legacy applications</p>
                                    </div>
                                    <div class="benefit-item" style="
                            padding: 15px;
                            background: rgba(241, 196, 15, 0.1);
                            ...
                            animation-delay: 0.3s;
                        ">
                                        <p style="margin: 0;">✅ Compliance with industry and platform-specific standards</p>
                                    </div>
                                    <div class="benefit-item" style="
                            padding: 15px;
                            background: rgba(231, 76, 60, 0.1);
                            ...
                            animation-delay: 0.4s;
                        ">
                                        <p style="margin: 0;">✅ Quality assurance and testing of mobile applications</p>
                                    </div>
                                </div>
                    ...
                    ">
                                    <p style="margin: 0; line-height: 1.6;">If you have a vision, TechTrail will help you bring it to life—faster and smarter. Let’s build the
                                        future together!</p>
                                </div>
                            </div>
                        </div>
