...
<body>
    ...
    <div class="container-fluid pt-2 pb-2" style="background-color: #f8f9fa;">
            ...
            <div class="grid-container">
                <div class="grid-item text-content">
                    ...
                    <p style="color: black; margin-bottom: 15px; animation: fadeInLeft 0.6s ease forwards;">
                        Enhance Your Business Performance with the Right ERP System
                    </p>
                    <p style="color: black; animation: fadeInLeft 0.6s ease forwards;">
                        As businesses grow, managing seamless connectivity between complex functional
                        departments becomes increasingly challenging. An Enterprise Resource Planning (ERP)
                        system empowers organizations to streamline operations, ensuring seamless integration of
                        business functions for improved efficiency and scalability.
                    </p>
                </div>
        ...
        <div class="contaienr-fluid about pt-0 pb-0" style="background-color: rgba(222, 234, 245, 0.95);">
            <div class="particles-container">
                ...
                ">
                        ...
                        padding-bottom: 15px;
                    ">Our team of functional and technical experts is dedicated to helping you implement the right
                                    ERP system for your business. We assist in:</h4>
                    ...
                    ">
                        ...
                        ">
                                        <p style="margin: 0;">1. Integrating systems across multiple locations for seamless management</p>
                                    </div>
                                    <div class="benefit-item" style="
                            padding: 15px;
                        ...
                        ">
                                        <p style="margin: 0;">2. Enhancing operational efficiency to drive business growth</p>
                                    </div> -->
                                    <div class="benefit-item" style="
                            padding: 15px;
                        ...
                        ">
                                        <p style="margin: 0;">3. Replacing outdated ERP or legacy systems with modern solutions</p>
                                    </div>
                                    <!-- <div class="benefit-item" style="
                            padding: 15px;
                            background: rgba(241, 196, 15, 0.1);
                        ...
                        ">
                                        <p style="margin: 0;">4. Improving customer service through streamlined processes</p>
                                    </div>
                                    <div class="benefit-item" style="
                            padding: 15px;
                        ...
                        ">
                                        <p style="margin: 0;">5. Ensuring compliance with accurate reporting and data management</p>
                                    </div>
                                    <div class="benefit-item" style="
                            padding: 15px;
                        ...
                        ">
                                        <p style="margin: 0;">6. Simplifying workflows to make employees&#39; tasks more efficient</p>
                                    </div>
                                    <div class="benefit-item" style="
                            padding: 15px;
                        ...
                        ">
                                        <p style="margin: 0;">7. Optimizing working capital and reducing unnecessary costs</p>
                                    </div> -->
                                </div>
                    ...
                    ">
                                    <p style="margin: 0; line-height: 1.6;">Choosing the right ERP system is crucial to aligning with your organization&#39;s infrastructure,
                                        operations, and long-term goals. At TechTrail, we not only help you select the most cost-
                                        effective solution but also define a clear roadmap for successful implementation.</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <!-- <div class="container-fluid">
            <div class="grid-container">
                <div class="grid-item image-content">
                    <img src="img/erp2.jpg" class="responsive-image">
                </div>
                <div class="grid-item text-content">
                    <h4 class="mt-4" style="text-align: right; animation: fadeInRight 0.6s ease forwards;">Why is ERP Important?</h4>
                    <p style="text-align: right; color: black; animation: fadeInRight 0.6s ease forwards;">
                        ERP systems unify essential business processes into a single integrated system, allowing organizations
                        to run efficiently, improve collaboration, and enhance decision-making. It helps reduce errors, optimize
                        resource allocation, and ensure real-time access to key business data.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="grid-container">
                <div class="grid-item text-content">
                    <h4 class="mt-4">Our collection of functional and technical experts will help you with implementing ERP in your business:</h4>
                    <ul class="list-unstyled" style="color:black">
                        <li>1. To integrate systems across multiple locations for better management</li>
                        <li>2. To position your company for growth by enhancing efficiency</li>
                        <li>3. To replace an old ERP or legacy system</li>
                        <li>4. To serve customers in a better way</li>
                        <li>5. To ensure reporting compliance</li>
                    </ul>
                </div>
                <div class="grid-item image-content">
                    <img src="img/erp3.jpg" class="responsive-image">
                </div>
            </div>
        </div>
    </div> -->
        ...
        <script>
            ...
            document.addEventListener("DOMContentLoaded", function() {
                ...
                let selectedService = urlParams.get("selected");

                // If no tab is selected, set "erp" as default
                if (!selectedService) {
                    selectedService = "erp";
                    // Redirect to the ERP page if no tab is selected
                    window.location.href = `erp.php?selected=erp`;
                }
