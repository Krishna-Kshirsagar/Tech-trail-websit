...
<body>
    ...
    <div class="container-fluid pt-2 pb-2" style="background-color: #f8f9fa;">
        <div class="container-fluid" style="padding: 0 150px; display: grid; gap: 20px;">
            <div style="display: grid; grid-template-columns: 1fr 1fr; align-items: center; gap: 20px;">
                <img src="img/web1.jpg" style="animation: fadeInLeft 0.6s ease forwards; animation-delay: 0.6s; max-height: 250px; width: 100%; object-fit: cover;" alt="Web Development Image" />
                <div>
                    <h4 class="mt-4" style="animation: fadeInRight 0.6s ease forwards; animation-delay: 0.6s;">Web Development</h4>
                    <p style="color: black; margin-bottom: 15px; animation: fadeInLeft 0.6s ease forwards; animation-delay: 0.6s; opacity: 0;">
                        Elevate Your Business with Custom Web Application Development
                    </p>
                    <p style="color: black; animation: fadeInRight 0.6s ease forwards; animation-delay: 0.9s; opacity: 0;">
                        In the digital age, your website is more than just an online presence—it’s a powerful tool to
                        attract, engage, and convert visitors into loyal customers. A well-designed and seamlessly
                        functioning web application not only enhances credibility but also strengthens your brand’s
                        trust and authority.
                    </p>
                </div>
            </div>
            ...
            <!-- <div style="display: grid; grid-template-columns: 1fr 1fr; align-items: center; gap: 20px;">
            <img src="img/web2.jpg" style="animation: fadeInLeft 0.6s ease forwards; animation-delay: 0.6s; max-height: 250px; width: 100%; object-fit: cover;">
            <div>
                <h4 class="mt-4" style="text-align: right; animation: fadeInRight 0.6s ease forwards; animation-delay: 0.9s;">Why is ERP Important?</h4>
                <p style="text-align: right; color: black; animation: fadeInRight 0.6s ease forwards; animation-delay: 0.9s;">
                    ERP systems unify essential business processes into a single integrated system, allowing organizations to run efficiently,
                    improve collaboration, and enhance decision-making. It helps reduce errors, optimize resource allocation, and ensure real-time
                    access to key business data.
                </p>
            </div>
        </div>
        
        <div style="display: grid; grid-template-columns: 1.4fr 1fr; align-items: center; gap: 20px;">
            <div>
                <h4 class="mt-4">Below are the good reasons for your business to have web applications:</h4>
                <ul style="color:black">
                    <li>1. For streamlining your sales and project management, operations, internal functions, etc.</li>
                    <li>2. For flexibility and versatility</li>
                    <li>3. For gaining more customers or a better serving platform for existing customers or both.</li>
                    <li>4. For offering innovative solutions to online users.</li>
                </ul>
            </div>
            <img src="img/web3.jpg" style="max-height: 250px; width: 100%; object-fit: cover;">
        </div> -->
        </div>
    </div>
        ...
        <div class="particles-container">
            ...
            <div class="container fade-in-right" style="position: relative; z-index: 2;">
                ...
                ">
                        ...
                        padding-bottom: 15px;
                    ">Efficient Work Order & Stock Management Integration:</h4>
                    ...
                    ">
                        ...
                        ">
                                    <p style="margin: 0;">✅ Optimize Operations – Streamline sales, project management, and internal workflows</p>
                                </div>
                                <div class="benefit-item" style="
                            padding: 15px;
                        ...
                        ">
                                    <p style="margin: 0;">✅ Enhance Flexibility &amp; Scalability – Adapt to evolving business needs with ease</p>
                                </div> -->
                                <div class="benefit-item" style="
                            padding: 15px;
                        ...
                        ">
                                    <p style="margin: 0;">In Fidael, after a customer or dealer confirms the order, the order had to be executed by
providing the required products and services (based on mode of engagement). We helped
Fidael staff to manage the product stock and work orders in an integrated way.
The end-to-end solution will be developed in multiple phases. In the current phase, the
emphasis will be on streamlining the work order management and stock management and
integrating it with quotation management.</p>
                                </div>
                                <!-- <div class="benefit-item" style="
                            padding: 15px;
                        ...
                        ">
                                    <p style="margin: 0;">✅ Deliver Innovative Solutions – Provide seamless and engaging online experiences</p>
                                </div> -->
                            </div>
                        </div>
                    </div>
            ...
            <div class="container fade-in-right" style="position: relative; z-index: 2;">
                ...
                ">
                    ...
                    ">
                            ...
                            animation: fadeInLeft 0.5s ease forwards;
                        ">
                                    <p style="margin: 0;">1. Custom Web Application Development</p>
                                </div>
                                <div class="benefit-item" style="
                            padding: 15px;
                            background: rgba(46, 204, 113, 0.1);
                            ...
                            animation-delay: 0.1s;
                        ">
                                    <p style="margin: 0;">2. Enterprise eCommerce Solutions</p>
                                </div>
                                <div class="benefit-item" style="
                            padding: 15px;
                            background: rgba(155, 89, 182, 0.1);
                            ...
                            animation-delay: 0.2s;
                        ">
                                    <p style="margin: 0;">3. Cross-Platform Application Development</p>
                                </div>
                                <div class="benefit-item" style="
                            padding: 15px;
                            background: rgba(241, 196, 15, 0.1);
                            ...
                            animation-delay: 0.3s;
                        ">
                                    <p style="margin: 0;">4. Web & Enterprise Portal Development</p>
                                </div>
                            </div>

                            <!-- Moved conclusion outside of benefits-grid -->
                        ...
                        width: 100%;
                    ">
                                <p style="margin: 0; line-height: 1.6;">At TechTrail, we craft tailored web solutions designed to enhance performance, drive growth, and set your business apart. Let's build a digital experience that makes a lasting impact!</p>
                            </div>
                        </div>
                    </div>
                </div>
